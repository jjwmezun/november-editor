...
const atticBlockTypes: readonly MapObjectType[] = Object.freeze( [
	...
	{
		name: `Pipe Corner Ring ( Horizontal )`,
		create: ( id, x, y ) => ( {
			id: id,
			x: x,
			y: y,
	...
	{
		name: `Pipe Corner Ring ( Vertical )`,
		create: ( id, x, y ) => ( {
			id: id,
			x: x,
			y: y,
